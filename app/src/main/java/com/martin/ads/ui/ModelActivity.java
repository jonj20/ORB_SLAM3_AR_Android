...
import com.martin.ads.slamar3.R;
...
public class ModelActivity extends Activity {
    ...
    class ExtractModelTask extends AsyncTask<Void,Void,Boolean>{
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            //ZipHelper.saveFile(context,resDir,"ORBvoc.txt","ORBvoc.txt",createNew);
            ZipHelper.saveFile(context,resDir,"PARAconfig.yaml","PARAconfig.yaml",createNew);
